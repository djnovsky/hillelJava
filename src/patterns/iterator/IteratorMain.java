...
public class IteratorMain {
    public static void main(String[] args) {
        ...
        linkedList.add(new Cat("tim","gray",2013));
        linkedList.add(new Cat("trohim","white",2011));
        linkedList.add(new Cat("murzik","black",2000));
        linkedList.add(new Cat("barsik","gray-red",2012));
